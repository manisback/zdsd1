				...
				actions : {
								...
								this.waitFor({
									...
									success : function (oList) {
										...
										if (!aItemsNotInTheList.length) {
											...
											sCurrentId = aEntityData[aEntityData.length - 1].SalesOrderNumber;
										} else {
											sCurrentId = aItemsNotInTheList[0].SalesOrderNumber;
										}
					...
					iRememberTheListItem : function (oListItem) {
						...
						this.getContext().currentItem = {
							...
							id: oBindingContext.getProperty("SalesOrderNumber"),
							title: oBindingContext.getProperty("SalesOrderNumber")
						};
					}
				},
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "SalesOrders (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'SalesOrders (0)'");
							},
					...
					theListShouldBeSortedAscendingOnUnitNumber : function () {
						return this.theListShouldBeSortedAscendingOnField("NetPriceAmount");
					},
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "SalesOrders (" + iExpectedLength + ")"}),
									success : function () {
