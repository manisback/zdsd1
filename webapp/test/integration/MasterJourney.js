sap.ui.define([
		...
		opaTest("MasterList Filtering on NetPriceAmount less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("NetPriceAmount").
		...
		opaTest("MasterList Filtering on NetPriceAmount more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 Currency").
				and.iPressOKInViewSelectionDialog();
